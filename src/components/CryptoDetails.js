...
const HighLowIndicator = ({ currentPrice, high, low }) => {
  ...
  return (
    <>
      <span
        className="h-1.5 w-[50%] rounded-l-lg bg-red"
        style={{ width: `${100 - green}%` }}
      >
        &nbsp;
      </span>
      <span
        className="h-1.5 w-[50%] rounded-r-lg bg-green"
        style={{ width: `${green}%` }}
      >
        &nbsp;
      </span>
...
const CryptoDetails = () => {
  ...
  return ReactDOM.createPortal(
    <div
      className="first-letter: absolute top-0 flex h-[130%] w-full items-center justify-center bg-gray-200 bg-opacity-30 font-open backdrop-blur-sm md:h-full "
      onClick={close}
    >
      <div
        className="relative h-full w-[90%] rounded-lg bg-gray-300 bg-opacity-75 text-white lg:h-[80] lg:w-[75%]"
      ...
      >
        ...
        {data ? (
          <div className="flex flex-col items-center justify-between w-full h-full p-4 lg:flex-row">
            <div className="flex h-full w-[85%] flex-col pr-2 lg:w-[55%] ">
              <div className="flex items-center w-full">
                ...
                <span
                  className="ml-2
        rounded bg-cyan bg-opacity-25 py-0.5 px-2.5 text-sm
        uppercase text-cyan
        "
                >
                  {data.symbol}
              ...
              <div className="flex w-full mt-6">
                <div className="flex flex-col w-full">
                  <div className="flex justify-between">
                    ...
                    <div
                      className={`ml-2 flex items-center rounded bg-opacity-25 px-1
              ...
              <div className="flex justify-between w-full mt-4">
                <div className="flex flex-col">
                  <a
                    target={"_blank"}
                    rel="noreferrer"
                    className="my-1 rounded bg-gray-200 px-1.5 py-0.5 text-sm text-gray-100"
                ...
                <div className="flex flex-col content-start">
                  ...
                  <div className="flex justify-between">
                    <div
                      className={`my-1 ml-2 flex items-center rounded bg-green bg-opacity-25
          px-1 text-sm font-medium uppercase text-green
          ...
          `}
                  ...
                  <div className="flex justify-between">
                    <div
                      className={`my-1 ml-2 flex items-center rounded bg-red bg-opacity-25
          ...
          `}
            ...
            <div className="flex h-full w-[90%] flex-col pl-3 lg:mt-20 lg:w-[55%]">
              <Chart id={data.id} />

              <div className="flex flex-col mt-8">
                <h3 className="py-1 text-white">
                  <span className="text-gray-100 capitalize mt-50">
                    market cap rank:{" "}
                  </span>{" "}
            ...
            <div className="flex items-center lg:absolute lg:bottom-8 lg:right-8">
