...
const Saved = () => {
  ...
  return (
    <section className="relative mt-16 mb-24 flex h-full w-[80%] flex-col">
      <div className="min-h-[60vh] w-full rounded  border border-gray-100 py-8">
        {savedData ? (
          ...
          <h1 className="flex min-h-[60vh] items-center justify-center text-lg text-cyan">
            There is no data to display!
          </h1>
        )}
        <button
          className="transition-ease absolute right-0 -top-10 ml-4
        w-[2rem] transition-all hover:scale-110
        "
